...
//						   5 Pro-nav (for kinematic seeker)
...
void Missile::def_guidance()
{
	...
	missile[405].init("grav_bias",0,"Gravity bias - g's","guidance","data","");
...
// Terminal, pro-nav 
// Member function of class 'Missile'
// Straight proportional navigation guidance
// Calculates acceleration commands based on LOS rates
//
// Return output
//			ACBX = acceleration command in body coord - g's
//
//191018 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
Matrix Missile::guidance_term_pronav()
{
    ...
    //double all=apny-GRAVB[1];
    //double ann=apnz+GRAVB[2];
