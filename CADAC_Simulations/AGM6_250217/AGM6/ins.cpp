...
//Error parameters (alpha spec) are inserted into the definitions
//
// mins = 0 ideal INS
//        1 real INS
// 
...
void Missile::def_ins()
{
	...
	missile[300].init("mins","int",0,"D INS mode. =0:ideal INS; =1:with INS errors","ins","data","");
	...
	missile[307].init("EWALKG",0,0,0,"Gyro Random walk - rad/sqrt(s)","ins","data","");
	...
	missile[310].init("ESCALG",gauss(0,2e-5),gauss(0,2.5e-5),gauss(0,2.5e-5),"Gyro scale factor error - parts","ins","data","");
	missile[311].init("EBIASG",gauss(0,1e-5),gauss(0,3.2e-6),gauss(0,3.2e-6),"Gyro bias - rad/s","ins","data","");
	...
	missile[316].init("EWALKA",0,0,0,"Accel random walk - (m/s)/sqrt(s)","ins","data","");
	...
	missile[332].init("thtvlcx",0,"Computed vertical flight path angle - deg","ins","out","");
	missile[333].init("psivlcx",0,"Computed heading angle - deg","ins","out","");	
	missile[334].init("FSPCB",0,0,0,"Computed specific force on body - N/kg","ins","out","");
	missile[335].init("phiblcx",0,"Computed Euler roll angle - deg","ins","out","");
...
//INS module
//Member function of class 'Missile'
//Error equations based on Zipfel,Eq.10.98
// Widnall and Grundy error model
//
// Nine error states:
//		position: north, east, down
//		velocity: north, east, down
//		tilt: east tilt, north tilt, azimuth
// 
// mins = 0 ideal INS
//        1 real INS with transfer alignment
// 
//020513 Created by Peter Zipfel
///////////////////////////////////////////////////////////////////////////////
...
void Missile::ins(double int_step)
{
	...
	phiblcx=atan2(tblc23,tblc33)*DEG;
	//-------------------------------------------------------------------------
	//loading module-variables
	//state variables
