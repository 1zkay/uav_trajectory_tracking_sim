...
public:
	...
	virtual void intercept(Packet *combus,int vehicle_slot,int num_vehicles,double int_step,const char * title)=0;
};
...
public:
	...
	virtual void intercept(Packet *combus,int vehicle_slot,int num_vehicles,double int_step,const char * title);
