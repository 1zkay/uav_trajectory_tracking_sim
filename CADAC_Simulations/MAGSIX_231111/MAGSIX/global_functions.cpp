...
{	
	...
	int strip_lines=0;
	ifstream *file_istream_list=nullptr;
				 ...
				 int nrotor)
{
	...
	int ncom_rotor6=0; //number of module variables in 'com_rotor6'
	Variable *data_rotor=nullptr; //Variable array stored in 'Packet data' of type Rotor
	int i(0),j(0);
