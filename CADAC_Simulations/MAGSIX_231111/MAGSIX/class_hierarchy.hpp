...
protected:
	...
	int *rotor_scrn_ind=nullptr; int rotor_scrn_count=0;

	//indicator array pointing to the module-variable which are to 
	//be written to the 'ploti.asc' files
	int *rotor_plot_ind=nullptr; int rotor_plot_count=0;

	//indicator array pointing to the module-variable which are to 
	//be written to 'combus' 'packets'
	int *rotor_com_ind=nullptr; int rotor_com_count=0;
...
public:
	Rotor(){};
	Rotor(Module *module_list=nullptr,int num_modules=0);
	virtual~Rotor();
