...
void Plane::tabout_banner(ofstream &ftabout,const char *title)
{
	const char *buff1=NULL;
	char buff2[15];
	int label_length=14;
...
void Plane::plot_banner(ofstream &fplot,const char *title)
{
	const char *buff1=NULL;
	char buff2[15];
	int label_length=8;
...
void Plane::event(const char *options)
{
	Variable *watch_variable_ptr=NULL;
	...
	if(event_epoch)
	{
		int *flat6_index_list=NULL;
		double *flat6_value_list=NULL;
		int flat6_size=NULL;
		int *plane_index_list=NULL;
		double *plane_value_list=NULL;
		int plane_size(0);
		int index(0);
		const char *integer=NULL;
		double value(0);
...
void Plane::document(ostream &fdoc,const char *title,Document *doc_plane6)
{
	fdoc<<"*********************************************************************************************************************\n";
	fdoc<<"********************************************** PLANE6 **************************************************************\n";
	fdoc<<"*********************************************************************************************************************\n";
...
///////////////////////////////////////////////////////////////////////////////
void Plane::read_tables(const char *file_name,Datadeck &datatable)
{
