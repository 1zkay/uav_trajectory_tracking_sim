...
///////////////////////////////////////////////////////////////////////////////
void merge_plot_files(string *plot_file_list,int num_plane,const char *title)
{	
	char line_clear[CHARL];
	char line[CHARL];
	char buff[CHARN];
				 ...
				 int nplane)
{
	...
	int ncom_plane6=0; //number of module variables in 'com_plane6'
	Variable *data_plane=NULL; //Variable array stored in 'Packet data' of type Plane
	int i(0),j(0);
...
//////////////////////////////////////////////////////////////////////////////
void parse_plot_traj_csv(string *files, int num_vehicles, bool merge, string type)
{
	for(int i=0; i<num_vehicles; i++){
