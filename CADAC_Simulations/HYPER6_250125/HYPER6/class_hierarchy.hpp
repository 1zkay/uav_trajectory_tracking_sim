...
protected:			
	...
	int *round6_scrn_ind=nullptr; int round6_scrn_count=0;

	//Indicator-array pointing to the module-variable which are to 
	//be written to the 'ploti.asc' files
	int *round6_plot_ind=nullptr; int round6_plot_count=0;

	//Indicator-array pointing to the module-variable which are to 
	//be written to 'combus' 'packets'
	int *round6_com_ind=nullptr; int round6_com_count=0;
public:
	Round6();
	virtual~Round6(){};
...
protected:			
	...
	//Indicator array pointing to the module-variable which are to 
	//be written to 'combus' 'packets'
	int *ground0_com_ind=nullptr; int ground0_com_count=0;
public:
	Ground0();
	virtual~Ground0(){};
