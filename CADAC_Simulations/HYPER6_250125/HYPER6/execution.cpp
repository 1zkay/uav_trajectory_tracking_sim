...
//131021 Made compatible with MS C++ V12 (2013), PZi
//190502 Output in 'csv' format added, PZi
///////////////////////////////////////////////////////////////////////////////
...
void execute(Vehicle &vehicle_list,Module *module_list,double sim_time,
			 ...
			 int num_hyper,int num_satellite,int num_radar,ofstream &ftraj,const char *title,bool traj_merge,
