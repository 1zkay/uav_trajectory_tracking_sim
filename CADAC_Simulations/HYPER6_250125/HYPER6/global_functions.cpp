				 ...
				 int nhyper,int nsatellite,int nradar)
{
	...
	int ncom_hyper6=0; //number of module variables in 'com_hyper6'
	int ncom_satellite3=0; //number of module variables in 'com_satellite3'
	int ncom_radar0=0; //number of module variables in 'com_radar0'
	...
	Variable *data_radar=NULL; //Variable array stored in 'Packet data' of type Radar
...
//150805 Housekeeping: NULL initializing of all pointers, PZi
///////////////////////////////////////////////////////////////////////////////
...
void traj_data(ofstream &ftraj,Packet *combus,int num_vehicles,bool merge)
{
	...
	for(int i=0;i<num_vehicles;i++)
	{
		...
		satellite_object=(int)id.find("t");
		radar_object=(int)id.find("r");
...
//020304 Correction in first while loop, PZi
///////////////////////////////////////////////////////////////////////////////
void merge_stat_files(string *stat_file_list,int num_hyper,const char *title)
{	
	char line_clear[CHARL];
	char line[CHARL];
	char buff[CHARN];
