...
public:
	...
	virtual void document(ostream &fdoc,char *run_title,Document *doc_vehicle)=0;
...
protected:
	...
	//indicator array pointing to the module-variable which are to 
	//be written to the screen
	int *aim_scrn_ind=nullptr; int aim_scrn_count=0;

	//indicator array pointing to the module-variable which are to 
	//be written to the 'ploti.asc' files
	int *aim_plot_ind=nullptr; int aim_plot_count=0;

	//indicator array pointing to the module-variable which are to 
	//be written to 'combus' 'packets'
	int *aim_com_ind=nullptr; int aim_com_count=0;
