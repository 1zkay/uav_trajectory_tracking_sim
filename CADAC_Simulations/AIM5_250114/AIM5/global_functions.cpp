				 ...
				 int naim,int naircraft)
{
	...
	int ncom_aim5(0); //number of module variables in 'com_aim5'
	int ncom_aircraft3(0); //number of module variables in 'com_aircraft3'
	Variable *data_aim=nullptr; //Variable array stored in 'Packet data' of type Aim
	Variable *data_aircraft=nullptr; //Variable array stored in 'Packet data' of type aircraft
