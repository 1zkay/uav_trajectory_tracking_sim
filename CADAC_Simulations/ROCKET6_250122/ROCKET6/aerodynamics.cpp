...
void Hyper::def_aerodynamics()
{
	...
	hyper[100].init("maero","int",0,"=11: last stage; =12: 2 stages; =13: 3 stages","aerodynamics","data","scrn");
...
void Hyper::aerodynamics(double int_step)
{
	...
	if(maero==13){
	   ...
	   ca0=aerotable.look_up("ca0slv1_vs_mach",vmach); // 230425 changed from ca0slv2 to ca0slv1 (Randy!)
	   caa=aerotable.look_up("caaslv1_vs_mach",vmach); //dito
	   ca0b=aerotable.look_up("ca0bslv1_vs_mach",vmach); //dito
	}
