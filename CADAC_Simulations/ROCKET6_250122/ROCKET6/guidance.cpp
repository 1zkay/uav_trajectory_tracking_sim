...
void Hyper::def_guidance()
{
	...
	hyper[444].init("num_stages","int",0,"Number of additional stages in boost phase - s","guidance","data","");
...
//mguide=5   
//   
//Ref: Jaggers, R."Multistage Linear Tangent Ascent Guidance
//     as Baselined for the Space Shuttle Vehicle", NASA MSC,
//     Internal Note MSC-EG-72-39, June 1972
//Also:Jaggers, R., "An Explicit Solution to the Exo-atmospheric Powered Flight Guidance and
//     Trajectory Optimization Problem for Rocket Propelled Vehicles", AIAA Paper, Vol. 1051, 1977.
//
