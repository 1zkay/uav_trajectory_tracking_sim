...
{
private:
	Variable *watch_variable_ptr=NULL;	//pointer to variable to be watched
	...
	int round6_size=0;			//size (number) of variables from round6 array
	int hyper_indices[NVAR]={};	//new variables to be read from 'hyper[]'
	double hyper_values[NVAR]={};	//new values to be given to variables
	int hyper_size=0;			//size (number) of variables from hyper array
public:
	Event(){};
	~Event(){};
...
private:
	...
	Variable *data=NULL;	//array of module-variables identified by "com" 
public:
	Packet(){};
	~Packet(){};
	///////////////////////////////////////////////////////////////////////////
...
{
private:
	int round6_index=0;	//markov variable index of 'round6[]'
	int vehicle_index=0;	//markov variable index of vehicle array ('hyper[]')
