...
//030404 Adapted to HYPER6 simulation, PZi
///////////////////////////////////////////////////////////////////////////////
void Hyper::tabout_banner(ofstream &ftabout,const char * title,int &nmonte,int &nmc)
{
	const char * buff1=NULL;
	char buff2[15];
	int label_length=14;
...
void Hyper::event(const char * options)
{
	...
	if(event_epoch)
	{
		int *round6_index_list=NULL;
		double *round6_value_list=NULL;
		int round6_size(0);
		int *hyper_index_list=NULL;
		double *hyper_value_list=NULL;
		int hyper_size(0);
		int index(0);
		const char * integer=NULL;
		double value(0);
...
//030404 Adapted to HYPER6 simulation, PZi
///////////////////////////////////////////////////////////////////////////////
void Hyper::document(ostream &fdoc,const char * title,Document *doc_hyper6)
{
	fdoc<<"*********************************************************************************************************************\n";
	fdoc<<"********************************************** HYPER6 **************************************************************\n";
	fdoc<<"*********************************************************************************************************************\n";
