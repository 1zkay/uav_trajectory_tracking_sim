...
//Reading input data from 'input.asc' and putting into 'round3' and 'hyper' arrays 
...
//	hyper5[nhyper5]	contains variables of all modules with empty slots removed
//	scrn_hyper5[nscrn_hyper5]	contains variables to be displayed at screen and 'tabout.asc'
//	plot_hyper5[nplot_hyper5] contains variables to be plotted, i.e., written to 'traj.asc'
//	com_hyper5[ncom_hyper5] contains variables for communication among vehicles
...
Hyper::Hyper(Module *module_list,int num_modules,int num_target,int num_satellite)
{
	...
	//creating module-variable array
	try{hyper=new Variable[NHYPER];}
	catch(bad_alloc xa){cerr<<"*** Error: hyper[] allocation failed ***\n";exit(1);}

	//zeroing module-variable array
	for(i=0;i<NHYPER;i++)hyper[i].init("empty",0," "," "," "," ");

	//calling initializer modules to build 'round3' and 'hyper' arrays
	...
	//sizing module-variable arrays 'hyper5','scrn_hyper5','plot_hyper5' arrays
	//their dimensions are the protected data:'nhyper5','nscrn_hyper5','nplot_hyper5'
	sizing_arrays();

	//allocating dynamic memory to the module-variable arrays
	try{hyper5=new Variable[nhyper5];}		
	catch(bad_alloc xa){cerr<<"*** Error: hyper5[] allocation failed *** \n";exit(1);}

	try{scrn_hyper5=new Variable[nscrn_hyper5];}
	catch(bad_alloc xa){cerr<<"*** Error: scrn_hyper5[] allocation failed *** \n";exit(1);}

	try{plot_hyper5=new Variable[nplot_hyper5];}
	catch(bad_alloc xa){cerr<<"*** Error: plot_hyper5[] allocation failed *** \n";exit(1);}

	try{com_hyper5=new Variable[ncom_hyper5];}
	catch(bad_alloc xa){cerr<<"*** Error: com_hyper5[] allocation failed *** \n";exit(1);}
	...
	//building 'hyper5' array (compacting and merging 'round3' and 'hyper' arrays)
	vehicle_array();

	//building 'scrn_hyper5' array from 'hyper5' array
	scrn_array();

	//building 'plot_hyper5' array from 'hyper5' array
	plot_array();
