...
//240711 Updated 'satellite_function.cpp', PZi
///////////////////////////////////////////////////////////////////////////////
...
void Satellite::vehicle_data(fstream &input)
{
	...
	const char *buff=nullptr;			//name of module-variable
	double data(0);		//data of module-variable 
	const char *comment ="//";
	const char *integer=nullptr;
	int int_data(0);
	int file_ptr(0);
	int e(0);
	const char *watchpoint=nullptr;
...
Packet Satellite::loading_packet_init(int num_hyper,int num_target,int num_satellite)
{
	string id="";
	char object[4];
	...
	h_count++;
	if(h_count==(num_satellite+1))h_count=1;
...
Packet Satellite::loading_packet(int num_hyper,int num_target,int num_satellite)
{
	int index(0);
	int i(0);
	int j(0);
...
void Satellite::document(ostream &fdoc,const char *title,Document *doc_satellite3)
{
	int i(0);
	int j(0);
