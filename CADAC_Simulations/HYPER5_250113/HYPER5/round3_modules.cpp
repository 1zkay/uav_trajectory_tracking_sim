...
//round3[10] is used for FSPV in 'Hyper::def_forces()' 
//
...
void Round3::def_environment()
{
	...
	round3[1].init("event_time",0,"Time elapsed during an event - s","environment","exec","plot");
	...
	round3[12].init("rho",0,"Air density - kg/m^3","environment","out","scrn");
...
//Member function of class 'Round3'
//Module-variable locations are assigned to round3[17-40]
// 
...
//240513 Added ground range calculation, PZi
///////////////////////////////////////////////////////////////////////////////
...
void Round3::def_newton()
{
	...
	round3[38].init("ground_range",0,"Ground range - m ","newton","dia","scrn,plot");
	round3[39].init("lonx_l",0,"launch longitude - deg","newton","save","");
	round3[40].init("latx_l",0,"Launch latitude - deg","newton","save","");
}
...
void Round3::init_newton()
{
	...
	round3[39].gets(lonx_l);
	round3[40].gets(latx_l);
}
///////////////////////////////////////////////////////////////////////////////
//Newton module
//Member function of class 'Round3'
...
void Round3::newton(double int_step)
{
	...
	double lonx_l=round3[39].real();
	double latx_l=round3[40].real();
	//state variables
	...
	//calculating ground range since lauch c=launch, t=vehicle)
	double dum=sin(latx*RAD)*sin(latx_l*RAD)+cos(latx*RAD)*cos(latx_l*RAD)*cos(lonx*RAD-lonx_l*RAD);
	ground_range=REARTH*acos(dum);
	// 
	//-------------------------------------------------------------------------
	//loading module-variables
	//state variables
