...
Packet Target::loading_packet_init(int num_hyper,int num_target,int num_satellite)
{
	string id="";
	char object[4];
	...
	h_count++;
	if(h_count==(num_target+1))h_count=1;
...
Packet Target::loading_packet(int num_hyper,int num_target,int num_satellite)
{
	int index(0);
	int i(0);
	int j(0);
