...
TRAJECTORY_FILE="${TRAJECTORY_FILE:-${SIM_ROOT}/src/uav_trajectory_tracking/config/target_trajectory.yaml}"
...
add_launch_arg "trajectory_stage_topic" "/${TARGET_NODE_NAMESPACE}/trajectory_tracker/current_stage"
...
add_launch_arg "trajectory_markers_topic" "/${TARGET_NODE_NAMESPACE}/trajectory_markers"
