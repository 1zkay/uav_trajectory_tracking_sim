...
void init(const char * na,double v1,double v2,double v3,double v4,double v5,
...
private:
	...
	char event_operator=NULL;		// < , > , =  three options of relational operators	
...
private:
	...
	int status=0;			//alive=1, dead=0 . hit=-1 (rockets are only stopped), 
...
private:
	...
	int flat3_index=0;	//markov variable index of 'flat3[]'
	int flat0_index=0;	//markov variable index of 'flat0[]'
	int vehicle_index=0;	//markov variable index of vehicle array ('missile[]','rocket[]','aircraft[]')
	double sigma=0;		//markov sigma value 
	double bcor=0;		//markov beta correlation value
	double saved=0;		//markov previous value
	bool status=0;		//markov noise status: on(true)/off(false)
public:
	Markov(){};
	~Markov(){};
